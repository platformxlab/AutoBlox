...
excluded_cats = ["PageRank", "DevTool", "FINANCIAL", "FIUHome", "MailServer", "MLPrep", "MSN", "MSRHM", "MSRMDS", "MSRPRN", "MSRPROJ", "RadiusAuth",
                 "TPCCTest", "MSRPROXY", "TPCETest", "VDI", "YCSBTest", "YCSBBlockFlex", "TPCE", "CloudStorage", "AdsDataServer"]
...
clustering_entries = int(min_entry * 0.7)
...
for cat in training_dat:
    ...
    for trace in traces:
        ...
        for ssd in ssd2trace:
            ...
            if len(ssd2trace[ssd]) < 6 * window_size:
                continue

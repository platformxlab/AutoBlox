...
#define DEBUG3(M) //std::cout<<M<<std::endl;
#define DEBUG4(M) //std::cout<<M<<std::endl;
#define DEBUG5(M) //std::cout<<M<<std::endl;
#define DEBUG6(M) //std::cout<<M<<std::endl;
#define DEBUG7(M) //std::cout<<M<<std::endl;
#define DEBUG8(M) //std::cout<<M<<std::endl;
#define DEBUG9(M) //std::cout<<M<<std::endl;
#define DEBUG10(M) //std::cout<<M<<std::endl;
#define DEBUG11(M) std::cout<<M<<std::endl;

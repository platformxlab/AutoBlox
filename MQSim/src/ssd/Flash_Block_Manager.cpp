...
namespace SSD_Components
{
	...
	void Flash_Block_Manager::Allocate_block_and_page_in_plane_for_user_write(const stream_id_type stream_id, NVM::FlashMemory::Physical_Page_Address& page_address)
	{
		...
		DEBUG3("Issuing user write on Channel:" << page_address.ChannelID << " Chip:" << page_address.ChipID << " Die:" << page_address.DieID << " Plane:" << page_address.PlaneID << " free block remaining:" << plane_record->Get_free_block_pool_size())
	...
	void Flash_Block_Manager::Allocate_block_and_page_in_plane_for_gc_write(const stream_id_type stream_id, NVM::FlashMemory::Physical_Page_Address& page_address)
	{
		...
		DEBUG3("Issuing gc write on Channel:" << page_address.ChannelID << " Chip:" << page_address.ChipID << " Die:" << page_address.DieID << " Plane:" << page_address.PlaneID << " free block remaining:" << plane_record->Get_free_block_pool_size())
	...
	void Flash_Block_Manager::Allocate_Pages_in_block_and_invalidate_remaining_for_preconditioning(const stream_id_type stream_id, const NVM::FlashMemory::Physical_Page_Address& plane_address, std::vector<NVM::FlashMemory::Physical_Page_Address>& page_addresses)
	{
		...
		DEBUG3("Issuing preconditioning on Channel:" << plane_address.ChannelID << " Chip:" << plane_address.ChipID << " Die:" << plane_address.DieID << " Plane:" << plane_address.PlaneID << " free block remaining:" << plane_record->Get_free_block_pool_size())
	...
	void Flash_Block_Manager::Allocate_block_and_page_in_plane_for_translation_write(const stream_id_type streamID, NVM::FlashMemory::Physical_Page_Address& page_address, bool is_for_gc)
	{
		...
		DEBUG3("Issuing transaction write on Channel:" << page_address.ChannelID << " Chip:" << page_address.ChipID << " Die:" << page_address.DieID << " Plane:" << page_address.PlaneID << " free block remaining:" << plane_record->Get_free_block_pool_size())

...
namespace SSD_Components
{
	NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
		...
		Content(content), RelatedRead(related_read),RelatedErase(nullptr), write_sectors_bitmap(written_sectors_bitmap), DataTimeStamp(data_timestamp),
	...
	NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
		...
		Content(content), RelatedRead(NULL),RelatedErase(nullptr), write_sectors_bitmap(written_sectors_bitmap), DataTimeStamp(data_timestamp),
		ExecutionMode(WriteExecutionModeType::SIMPLE)
	{
	}

...
namespace SSD_Components
{
	...
	public:
		...
		Data_Cache_Slot_Type Get_next_slot();
		bool Delete_front();
		...
		void Insert_warmup_data(const stream_id_type stream_id, const LPA_type lpn, const data_cache_content_type content,const data_timestamp_type timestamp, const page_status_type state_bitmap_of_read_sectors, const Cache_Slot_Status status);

...
{
public:
	SSD_Device(Device_Parameter_Set* parameters, std::vector<IO_Flow_Parameter_Set*>* io_flows, std::string output_filename, std::string DRAM_filename);
	~SSD_Device();
	...
	void Perform_preconditioning(std::vector<Utils::Workload_Statistics*> workload_stats, std::string input_filename);

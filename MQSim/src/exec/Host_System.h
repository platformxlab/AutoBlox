...
{
public:
	Host_System(Host_Parameter_Set* parameters, bool preconditioning_required, SSD_Components::Host_Interface_Base* ssd_host_interface, std::string cache_input_filename, double device_throughput);
	~Host_System();
...
private:
	...
	std::string cache_input_filename;
};

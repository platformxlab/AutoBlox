...
public:
	IO_Flow_Parameter_Set() {
		Cache_Input_Filename = "";
		Cache_Output_Filename = "";
		Device_Throughput = "";
		Best_Queue_Size = "";
	}
	...
	std::string Cache_Input_Filename;//Filename of initial cache status
	std::string Cache_Output_Filename;//Filename of initial cache status
	std::string Device_Throughput;// Device Throughput of initial cache status
	std::string Best_Queue_Size;// Device Throughput of initial cache status
	std::string Dram_Output_Filename;

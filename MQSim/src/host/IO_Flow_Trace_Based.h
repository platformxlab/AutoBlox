...
#define PREFETCH_TIME_WINDOW 5000000000
// #define DEVICE_BANDWIDTH 0.029296875
// #define DEVICE_BANDWIDTH 0.0341796875
// #define DEVICE_BANDWIDTH 0.05859375
// #define DEVICE_BANDWIDTH 0.15625
// #define DEVICE_BANDWIDTH 1.953125
#define DEVICE_BANDWIDTH 2.63671875
...
public:
	IO_Flow_Trace_Based(const sim_object_id_type &name, uint16_t flow_id, LHA_type start_lsa_on_device, LHA_type end_lsa_on_device, uint16_t io_queue_id,
						...
						bool enabled_logging, sim_time_type logging_period, std::string logging_file_path, double device_bandwidth) ;
	~IO_Flow_Trace_Based();
...
private:
	...
	// for offset-based trace replay
	std::vector<std::vector<std::string>> trace_lines_in_window;
	unsigned int cur_traceline;
	sim_time_type time_offset;
	double estimated_workload_bandwidth;
	bool fileread_finished;
